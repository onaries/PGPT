...
def pose_resnet(cfg, flag=1, pretrained=True, progress=True, **kwargs):
    num_layers = cfg.MODEL.EXTRA.NUM_LAYERS
    ...
    checkpoint = 'https://safemotion.kr/torch/pose_gcn.pth.tar'
    if pretrained:
        state_dict = torch.hub.load_state_dict_from_url(checkpoint, progress=progress)
